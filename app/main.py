...
from app.api.v1.endpoints import auth, admin, ekyc, charter, compliance # Import the new compliance router
...
app.include_router(compliance.router, prefix="/api/v1", tags=["Compliance Management"]) # Add the new router
